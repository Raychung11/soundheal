...
<section class="max-w-md mx-auto px-6 py-24">
  ...
  <p class="mt-8 text-center text-sm text-beige-100/60">New to <?= e(config('app.name')) ?>? <a href="<?= url('/public/register.php') ?>" class="text-gold-400 hover:text-gold-300">Create an account</a></p>
</section>
